...
<ul class="grid list-none grid-cols-1 gap-10 text-center md:grid-cols-2">
  ...
  <li class="md:w-128 w-full self-start text-center">
    ...
    <p>
      ...
      research and analysis projects making a significant impact on world
      health.
    </p>
  </li>
</ul>
...
You can keep up with our projects supporting research and analysis and more in our [blog](/articles). To find out more about Fjelltopp's data science capabilities, or how we can help with your health data solutions, get in touch with us.
