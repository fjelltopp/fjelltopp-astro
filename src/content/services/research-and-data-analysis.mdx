...
<ul class="grid grid-flow-col grid-rows-2 justify-items-center text-center gap-10" style="list-style-type: none;">
    <li class="self-start w-full md:w-128 text-center">
        <Image class="h-48 w-auto mx-auto" src={clipboard} alt="" />
        <h3>Easy</h3>
    ...
    <li class="self-start w-full md:w-128 text-center">
        <Image class="h-48 w-auto mx-auto" src={check} alt="" />
        <h3>Transparent</h3>
    ...
    <li class="self-start w-full md:w-128 text-center">
        <Image class="h-48 w-auto mx-auto" src={recycle} alt="" />
        <h3>Repeatable</h3>
    ...
    <li class="self-start w-full md:w-128 text-center">
        <Image class="h-48 w-auto mx-auto" src={world} alt="" />
        <h3>Impactful</h3>
