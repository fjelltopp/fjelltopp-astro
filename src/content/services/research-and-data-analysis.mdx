...
<ul class="columns-2 text-center" style="list-style-type: none;">
    <li class="break-inside-avoid">
        <Image class="place-self-center" src={clipboard} alt="" />
        <h3>Easy</h3>
    ...
    <li class="break-inside-avoid">
        <Image class="place-self-center" src={check} alt="" />
        <h3>Transparent</h3>
    ...
    <li class="break-inside-avoid">
        <Image class="place-self-center" src={recycle} alt="" />
        <h3>Repeatable</h3>
    ...
    <li class="break-inside-avoid">
        <Image class="place-self-center" src={world} alt="" />
        <h3>Impactful</h3>
