...
<ul class="grid list-none grid-cols-1 gap-10 text-center md:grid-cols-2">
  ...
  <li class="md:w-128 w-full self-start">
    ...
    <h3>Interoperable</h3>
    <p>
      Safely allow third-parties to configure programmatic access to your data
      e.g. for automated data refreshing or system interoperability. Everything
      a user can do, a programme can do (and more) via the API.
    </p>
  </li>
  <li class="md:w-128 w-full self-start">
