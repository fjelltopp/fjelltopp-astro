...
<ul class="grid grid-flow-col grid-rows-2 justify-items-center text-center gap-10" style="list-style-type: none;">
    <li class="self-start w-full md:w-128 text-center">
        <Image class="h-48 w-auto mx-auto" src={hub} alt="" />
        <h3>Findable</h3>
    ...
    <li class="self-start w-full md:w-128">
        <Image class="h-48 w-auto mx-auto" src={fingerprint} alt="" />
        <h3>Accessible</h3>
    ...
    <li class="self-start w-full md:w-128">
        <Image class="h-48 w-auto mx-auto" src={cogs} alt="" />
        <h3>Interoperable</h3>
    ...
    <li class="self-start w-full md:w-128">
        <Image class="h-48 w-auto mx-auto" src={documents} alt="" />
        <h3>Reusable</h3>
