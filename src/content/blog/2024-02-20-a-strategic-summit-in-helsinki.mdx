...
import helsinki from "../../assets/summits/2024-helsinki/tapio-haaja-I9SWvZ9sO2U-unsplash_letterbox.jpg";
import teamInLibrary from "../../assets/summits/2024-helsinki/library.jpg";
import working from "../../assets/summits/2024-helsinki/working.jpg";
import library from "../../assets/summits/2024-helsinki/vadim-morozov-Tt9zCFO0zfA-unsplash.jpg";
...
<Image class="place-self-start w-full max-h-120 object-cover object-center pr-5" src={helsinki} alt="TODO"/>
...
<div class="flex flex-col md:flex-row items-center justify-between">
    <Image class="place-self-start w-1/3 max-h-120 object-cover object-center" src={teamInLibrary} alt="TODO"/>
    <Image class="place-self-end w-2/3 max-h-120 object-cover object-center" src={working} alt="TODO"/>
</div>
...
<Image class="place-self-start w-1/3 h-full object-cover object-center md:mr-5 float-left" src={library} alt="TODO"/>
