...
<div class="flex flex-col items-center justify-between md:flex-row">
  <Image
    class="max-h-120 w-1/3 place-self-start object-cover object-center"
    src={teamInLibrary}
    alt="TODO"
  />
  <Image
    class="max-h-120 w-2/3 place-self-end object-cover object-center"
    src={working}
    alt="TODO"
  />
</div>
...
<Image
  class="float-left h-full w-1/3 place-self-start object-cover object-center md:mr-5"
  src={library}
  alt="TODO"
/>
