...
import dots5 from "../../assets/dots/dots5.jpg";
...
<Image class="w-full md:float-left md:mr-5 md:w-1/3" src={mockUp1} alt="TODO" />
...
<Image class="w-full md:float-right md:ml-5 md:w-2/5" src={dots5} alt="TODO" />
...
<Image class="w-full md:float-right md:ml-5 md:w-2/5" src={dots2} alt="TODO" />
...
So that's a _brief_ introduction to health information systems. Now it's time to have a chat. Please don't hesitate to get in touch for a free, no strings attached catch up. Let's find a solution for you. Get in touch [here](/fjelltopp-astro/#contact).
