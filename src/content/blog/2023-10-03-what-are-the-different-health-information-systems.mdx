...
<Image class="w-full md:float-left md:w-1/3 md:mr-5" src={mockUp1} alt="TODO"/>
...
<Image class="w-full md:float-right md:w-2/5 md:ml-5" src={dots5} alt="TODO"/>
...
<Image class="w-full md:float-right md:w-2/5 md:ml-5" src={dots2} alt="TODO"/>
