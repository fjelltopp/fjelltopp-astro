---
title: "Principle #5 Secure but accessible data"
pubDate: 2023-06-19T15:10:47+01:00
author: "Dr Jonathan Berry"
summary: "Data should be secure but accessible.  This is a balancing act that requires careful consideration of the risks and benefits."
...
import mockUp1 from "../../assets/product/fjelltopp-mock-up-1.jpg";
import dots9 from "../../assets/dots/dots9.jpg";

_This is the second post in a series that outlines "[Six principles for sound data management](/articles/2023-05-23-six-principles-of-sound-data-management/)"._
...
<Image class="w-full md:float-right md:ml-5 md:w-1/3" src={dots9} alt="TODO" />
...
[Read Principle #2 Maintain Metadata](/articles/2023-06-19-data-management-principle-maintain-metadata/)
