...
authImage: ../../assets/team/jonathan-berry.jpg
---

import { Image } from "astro:assets";
import malawiMockUp3 from "../../assets/product/malawi-mock-up-3.jpg";
...
Fjelltopp has struggled to find professional communities within the public health informatics sector. Shiriki has been a great place for us to learn and network with others. Please do [get in touch](/#contact) and tell us about any relevant professional communities you are part of.

<Image
  class="w-full md:float-left md:mr-5 md:w-1/3"
  src={malawiMockUp3}
  alt="TODO"
/>
...
Jonathan led a webinar concerning our recent case study implementing a [Document Management System for the Department of HIV and AIDS for the Malawi Ministry of Health (MOH).](/projects/document-management-system-for-the-department-of-hiv-and-aids-malawi-moh/)
...
Working together we created an open source data repository using [CKAN's](https://ckan.org/) pre-existing features as well as some tailor developed features. The result was a user-friendly, safe and centralised place for the client to store their datasets, reports and documents.
...
If you'd like Jonathan to talk about any of our other projects, experience and work in a webinar - or if you'd just like to pick the Fjelltopp hive mind to see if we can help with your health data issue, please don't hesitate to [get in touch](/#contact). No strings attached.
