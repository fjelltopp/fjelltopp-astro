...
_This is the fifth post in a series that outlines “[Six principles for sound data management](/articles/2023-05-23-six-principles-of-sound-data-management/)“._
...
Validation should take place wherever there is an "unknown entity" interacting with your data. Furthermore it should take place _as early as possible_ after that interaction to minimise the knock on effect of poor data quality across your system. As discussed in principle [\#3 Automate where possible,](/articles/2023-06-19-data-management-principle-automate-wherever-possible/) "Computer's don't make mistakes; humans do." Humans are likely to be the most common "unknown entity" in your system!

In most public-health cases it is therefore essential to validate at the point of "data entry". In many of Fjelltopp's projects data is submitted by humans using an electronic form. Implementing sound input validation as part of the form's user interface is essential. In Fjelltopp's project ["The AIDS Data Repository"](/projects/the-aids-data-repository-for-unaids-geneva/) users prepare and submit data tables to our data repository. Each table receives comprehensive validation every single time a new version is uploaded to our system.
...
<Image
  class="w-full pl-5 md:float-right md:w-1/4"
  src={teamAtLaptop}
  alt="TODO"
/>
...
<Image
  class="h-165 w-full object-cover object-center md:float-left md:mr-5 md:w-1/4"
  src={dots13}
  alt="TODO"
  height="1000"
/>
...
<Image
  class="h-120 w-full object-cover object-center"
  src={dots12}
  alt="TODO"
/>
...
[Read Principle #5 Version Everything](/articles/2023-06-19-data-management-principle-version-everything/)
