...
<Image class="w-full md:float-right md:w-1/3 pl-5" src={malawiMockUp1} alt="TODO"/>
...
<Image class="h-100 w-full md:float-left md:w-1/4 md:mr-5 object-cover object-center" src={dots2} alt="TODO"/>
