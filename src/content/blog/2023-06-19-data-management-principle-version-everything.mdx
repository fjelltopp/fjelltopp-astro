---
title: "Principle #6 Version everything"
pubDate: 2023-06-19T15:10:47+01:00
author: "Dr Jonathan Berry"
summary: "Versioning is essential for data management.  It allows you to track changes, roll back if necessary, and maintain a clear audit trail."
coverImage: ../../assets/dots/dots11.jpg
type: "Article"
language: "en"
tags:
  - 6Principles
...
import malawiMockUp1 from "../../assets/product/malawi-mock-up-1.png";
import dots2 from "../../assets/dots/dots2.jpg";

_This is the sixth post in a series that outlines "[Six principles for sound data management](/articles/2023-05-23-six-principles-of-sound-data-management/)"._
...
<Image
  class="h-100 w-full object-cover object-center md:float-left md:mr-5 md:w-1/4"
  src={dots2}
  alt="TODO"
/>
...
Fjelltopp would be delighted to discuss any of the above points with you - you can set up a free meeting with us [here](/#contact).
