...
<Image
  class="md:w-md place-self-start pr-5 sm:w-full md:float-right"
  src={malawiMockUp1}
  alt="TODO"
/>
...
Fjelltopp has great experience with CKAN after working with it on many different projects. We can help set you up with a fully hosted and maintained CKAN instance with our [CKAN support service](/services/data-catalogues-and-hubs). When you work with us you also benefit from our wider related experience which we've gained from [multiple other projects](/projects/) looking at sound health data management in low and middle income countries.

Stay tuned for our next blog - our must read guide for your developers, which will have our tips and tricks for maintaining CKAN. To make sure you don't miss it, sign up to our newsletter at the bottom of our website [here](/articles/).

To find out more about CKAN setup, maintenance and more, please don't hesitate to [get in touch](/#contact) with the Fjelltopp team today.
