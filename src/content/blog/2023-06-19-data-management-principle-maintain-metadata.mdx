...
import checklist from "../../assets/pics/glenn-carstens-peters-RLw-UC03Gwc-unsplash.jpg";

_This is the third post in a series that outlines “[Six principles for sound data management](/articles/2023-05-23-six-principles-of-sound-data-management/)“._
...
<Image class="w-full md:float-left md:mr-5 md:w-1/3" src={dots5} alt="TODO" />
...
<Image class="w-ful py-5" src={mockUp3} alt="TODO" />
...
<Image
  class="h-200 md: float-right w-full object-cover object-center md:ml-5 md:w-1/3"
  src={checklist}
  alt="TODO"
/>
...
[Read Principle #3 Automate wherever possible](/articles/2023-06-19-data-management-principle-automate-wherever-possible/)
