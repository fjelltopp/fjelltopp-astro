...
<Image class="w-full md:w-1/3 md:float-left md:mr-5" src={dots5} alt="TODO" />
...
<Image class="h-200 w-full md:w-1/3 md: float-right md:ml-5 object-cover object-center" src={checklist} alt="TODO" />
