...
_If you haven't already, take a look at [part one of this blog](/articles/2024-04-30-health-data-analysis-common-health-data-types) to find out what health data analysis is and what types of data we commonly work with._
...
<Image
  class="max-h-120 w-full place-self-start object-cover object-center pr-5"
  src={dots4}
  alt="TODO"
/>
