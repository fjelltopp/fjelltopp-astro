...
import teamInDiscussion from "../../assets/summits/2022-krakow/team-in-discussion.jpg";

_This is the fourth post in a series that outlines "[Six principles for sound data management](/articles/2023-05-23-six-principles-of-sound-data-management/)"._
...
<Image class="w-full" src={teamInDiscussion} alt="TODO" />
...
[Read Principle #4 Validate early and often](/articles/2023-06-19-data-management-principle-validate-early-often/)
